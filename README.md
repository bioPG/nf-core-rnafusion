...
**nf-core/rnafusion** is a bioinformatics best-practice analysis pipeline for This pipeline is used for calling fusion genes using RNA-seq data.
...
nf-core/rnafusion was originally written by du jun.
